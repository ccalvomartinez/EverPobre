...
-(void) motionEnded:(UIEventSubtype)motion
    ...
    if(motion == UIEventSubtypeMotionShake){
        ...
        UIAlertController *alert =[UIAlertController alertControllerWithTitle:@"Alerta"
                                                                      message:@"¿Qué quiere hacer? Para no hacer nada, pulse Cancelar"
        ...
        if ([self.fetchedResultsController.managedObjectContext.undoManager canUndo]){
            UIAlertAction *undo = [UIAlertAction actionWithTitle:@"Deshacer cambios"
        ...
        if([self.fetchedResultsController.managedObjectContext.undoManager canRedo]){
            UIAlertAction *redo = [UIAlertAction actionWithTitle:@"Rehacer cambios"
                                                           style:UIAlertActionStyleDefault
                                                         handler:	^(UIAlertAction * action){
